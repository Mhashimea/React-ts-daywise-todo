  ...
  return (
    <div className="bg-white border  p-4 rounded-md todo-card mb-3">
      <div className="flex items-start">
        <Checkbox onChange={(evt) => onChangeTodo(evt, data)} checked={data.status === 'COMPLETED'}></Checkbox>
        <div className="flex items-start ml-2 w-full">
          <div className="flex-1">
            <Link to={'/todos/' + data.id} className="text-base font-semibold mb-1 cursor-pointer">
              {data.name}
            </Link>
